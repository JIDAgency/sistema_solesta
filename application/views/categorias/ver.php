        ...
        <div class="content-body">
            ...
            <ul class="list-inline">
                <?php foreach ($categorias_list as $categoria_row): ?>
                    <li>
                        <a class="btn btn-purple btn-darken-3 round btn-min-width mr-1 mb-1" href="<?php echo site_url("categorias/ver/".$categoria_row->url); ?>"><?php echo ucwords(mb_strtolower($categoria_row->nombre)); ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
